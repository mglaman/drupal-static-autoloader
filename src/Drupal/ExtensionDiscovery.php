...
class ExtensionDiscovery
{
   ...
   */
    public function __construct(string $root, array $profile_directories = null, string $site_path = null)
    {
        $this->root = $root;
   ...
   *
   * @return \mglaman\DrupalStaticAutoloader\Drupal\Extension[]
